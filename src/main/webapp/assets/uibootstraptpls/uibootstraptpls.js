...
.controller('DatepickerController', ['$scope', '$attrs', 'dateFilter', 'datepickerConfig', function($scope, $attrs, dateFilter, dtConfig) {
  ...
  function makeDate(date, format, isSelected, isSecondary) {//Rishabh
    var isToday = (date.toDateString() == (new Date()).toDateString());
    var yyyymmdd = ""+date.yyyymmdd();
    var isActive = (global_forDate == yyyymmdd);
    return { date: date,
...
function ($compile, $parse, $document, $position, dateFilter, datepickerPopupConfig, datepickerConfig) {
  return {
    ...
    link: function(originalScope, element, attrs, ngModel) {
      ...
      if (attrs.forDate) {
        addWatchableAttribute(attrs.forDate, 'forDate', 'for-date');
        global_forDate = attrs.forDate;
      }
...
var global_forDate = "";
//Rishabh-date box formatting
angular.module("template/datepicker/datepicker.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/datepicker.html",
    "<table>\n" +
    "  <thead>\n" +
    "    <tr class=\"text-center\">\n" +
    "      <th><button type=\"button\" class=\"btn pull-left\" ng-click=\"move(-1)\"><i class=\"glyphicon glyphicon-arrow-left\"></i></button></th>\n" +
    "      <th colspan=\"{{rows[0].length - 2 + showWeekNumbers}}\"><button type=\"button\" class=\"btn btn-block\" ng-click=\"toggleMode()\"><strong>{{title}}</strong></button></th>\n" +
    "      <th><button type=\"button\" class=\"btn pull-right\" ng-click=\"move(1)\"><i class=\"glyphicon glyphicon-arrow-right\"></i></button></th>\n" +
    "    </tr>\n" +
    "    <tr class=\"text-center\" ng-show=\"labels.length > 0\">\n" +
    "      <th ng-show=\"showWeekNumbers\" style=\"text-align:center;\">wk#</th>\n" +
    "      <th ng-repeat=\"label in labels\" style=\"text-align:center;\">{{label}}</th>\n" +
    "    </tr>\n" +
    "  </thead>\n" +
    "  <tbody>\n" +
    ...
    "        <button type=\"button\" style=\"width:100%; border:1px solid #888888;\" class=\"btn\" ng-class=\"{'btn-primary btn-primary-ilodge': dt.isActive, 'btn-danger btn-danger-ilodge':dt.today }\" ng-click=\"select(dt.date)\" ng-disabled=\"dt.disabled\"><span ng-class=\"{muted: dt.secondary}\">{{dt.label}}</span></button>\n" +
    "      </td>\n" +
    "    </tr>\n" +
    "  </tbody>\n" +
    "</table>\n" +
...
angular.module("template/datepicker/popup.html", []).run(["$templateCache", function($templateCache) {
  $templateCache.put("template/datepicker/popup.html",
    ...
    "			<button type=\"button\" class=\"btn btn-small btn-danger btn-danger-ilodge\" ng-click=\"today()\">{{currentText}}</button>\n" +
    ...
    //"			<button type=\"button\" class=\"btn btn-small btn-inverse\" ng-click=\"clear()\">{{clearText}}</button>\n" +
    "		</span>\n" +
    "		<span class=\"btn-group pull-right\">\n" +
    //"			<button type=\"button\" class=\"btn btn-small btn-inverse\" ng-click=\"clear()\">{{clearText}}</button>\n" +
    "			<button type=\"button\" class=\"btn btn-small btn-primary btn-primary-ilodge\" ng-click=\"isOpen = false\">{{closeText}}</button>\n" +
    "		</span>\n" +
    "	</li>\n" +
    "</ul>\n" +
    "");
